...
public class GlobalConstants {
	...
	public static final String AP_CURLEC_EMP_ID = "platform.ap.curlec.employee.id";
	public static final String AP_CURLEC_MERCHANT_ID = "platform.ap.curlec.merchant.id";
	public static final String MP_CURLEC_EMP_ID = "platform.mp.curlec.employee.id";
	public static final String MP_CURLEC_MERCHANT_ID = "platform.mp.curlec.merchant.id";
